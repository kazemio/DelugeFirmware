...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_MACRO, "MIDI Macro"},
        ...
        {STRING_FOR_MACRO, "Macro"},
        {STRING_FOR_MIDI_MACRO, "MIDI Macro"},
        ...
        {STRING_FOR_MACRO_ENABLED, "Enabled"},
        {STRING_FOR_MACRO_ENABLE_ALL, "Enable All"},
