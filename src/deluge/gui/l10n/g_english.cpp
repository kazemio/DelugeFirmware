...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_24DB_SVF, "24dB SVF"},
        {STRING_FOR_24DB_SVF_SHORT, "24dB"},
        ...
        {STRING_FOR_ARP_MIDI_INTERCEPT, "Intercept MIDI"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_SHORTCUT_OVERLAY, "Shortcut Overlay"},
        {STRING_FOR_COMMUNITY_FEATURE_MACROS, "Macros"},
        {STRING_FOR_COMMUNITY_FEATURE_SHOW_REAL_UNITS, "Show Real Units"},
        {STRING_FOR_COMMUNITY_FEATURE_MODFX_POST_DOTT, "ModFX Post DOTT"},
        {STRING_FOR_COMMUNITY_FEATURE_SPECTRUM_ANALYZER, "Spectrum Analyzer"},
        {STRING_FOR_TRACK_STILL_HAS_CLIPS_IN_SESSION, "Track still has clips in session"},
        {STRING_FOR_FX_TRACK_ALREADY_EXISTS, "FX track\nalready exists"},
        ...
        {STRING_FOR_LFO3_SYNC, "LFO3 sync"},
        {STRING_FOR_LFO4_SYNC, "LFO4 sync"},
        ...
        {STRING_FOR_COMPRESSOR_CHARACTER, "Character"},
        {STRING_FOR_COMPRESSOR_LOW_CROSSOVER, "Low Crossover"},
        {STRING_FOR_COMPRESSOR_HIGH_CROSSOVER, "High Crossover"},
        {STRING_FOR_COMPRESSOR_UP_DOWN_SKEW, "Up/Dn"},
        {STRING_FOR_COMPRESSOR_LOW_LEVEL, "Low Level"},
        {STRING_FOR_COMPRESSOR_MID_LEVEL, "Mid Level"},
        {STRING_FOR_COMPRESSOR_HIGH_LEVEL, "High Level"},
        {STRING_FOR_COMPRESSOR_LOW_THRESHOLD, "Low Threshold"},
        {STRING_FOR_COMPRESSOR_MID_THRESHOLD, "Mid Threshold"},
        {STRING_FOR_COMPRESSOR_HIGH_THRESHOLD, "High Threshold"},
        {STRING_FOR_COMPRESSOR_LOW_RATIO, "Low Ratio"},
        {STRING_FOR_COMPRESSOR_MID_RATIO, "Mid Ratio"},
        {STRING_FOR_COMPRESSOR_HIGH_RATIO, "High Ratio"},
        {STRING_FOR_COMPRESSOR_LOW_BW, "Low Bandwidth"},
        {STRING_FOR_COMPRESSOR_MID_BW, "Mid Bandwidth"},
        {STRING_FOR_COMPRESSOR_HIGH_BW, "High Bandwidth"},
        {STRING_FOR_COMPRESSOR_OUTPUT_GAIN, "Output Gain"},
        ...
        {STRING_FOR_MACRO_DRIVEN, "Macro Driven"},
        {STRING_FOR_MACRO_DRIVEN_STATUS, "(Macro Driven)"},
        ...
        {STRING_FOR_CONFIGURE_EXPORT_STEMS_KIT_ROWS, "Kit Rows"},
        ...
        {STRING_FOR_MACRO, "Macros"},
        {STRING_FOR_MACROS, "Macros"},
        {STRING_FOR_PARAMETERS, "Parameters"},
        {STRING_FOR_MACRO_1, "Macro 1"},
        {STRING_FOR_MACRO_2, "Macro 2"},
        {STRING_FOR_MACRO_3, "Macro 3"},
        {STRING_FOR_MACRO_4, "Macro 4"},
        {STRING_FOR_MACRO_SOURCE, "Source"},
        {STRING_FOR_MACRO_TARGETS, "Targets"},
        {STRING_FOR_MACRO_TARGET_1, "Target 1"},
        {STRING_FOR_MACRO_TARGET_2, "Target 2"},
        {STRING_FOR_MACRO_TARGET_3, "Target 3"},
        {STRING_FOR_MACRO_TARGET_4, "Target 4"},
        {STRING_FOR_MACRO_TARGET_5, "Target 5"},
        {STRING_FOR_MACRO_TARGET_6, "Target 6"},
        {STRING_FOR_MACRO_TARGET_7, "Target 7"},
        {STRING_FOR_MACRO_TARGET_8, "Target 8"},
        {STRING_FOR_MACRO_TARGET_DEST, "Dest"},
