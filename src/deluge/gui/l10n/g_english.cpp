...
<<<<<<< HEAD
        ...
        {STRING_FOR_FAN_OUT_GROUP_1, "Group 1"},
        {STRING_FOR_FAN_OUT_GROUP_2, "Group 2"},
        {STRING_FOR_FAN_OUT_GROUP_3, "Group 3"},
        {STRING_FOR_FAN_OUT_GROUP_4, "Group 4"},
        {STRING_FOR_FAN_OUT_SOURCE, "Source"},
        {STRING_FOR_FAN_OUT_DESTINATIONS, "Destinations"},
        {STRING_FOR_FAN_OUT_DEST_1, "Dest 1"},
        {STRING_FOR_FAN_OUT_DEST_2, "Dest 2"},
        {STRING_FOR_FAN_OUT_DEST_3, "Dest 3"},
        {STRING_FOR_FAN_OUT_DEST_4, "Dest 4"},
        {STRING_FOR_FAN_OUT_DEST_5, "Dest 5"},
        {STRING_FOR_FAN_OUT_DEST_6, "Dest 6"},
        {STRING_FOR_FAN_OUT_DEST_7, "Dest 7"},
        {STRING_FOR_FAN_OUT_DEST_8, "Dest 8"},
        {STRING_FOR_FAN_OUT_DEST_CC, "CC"},
        {STRING_FOR_FAN_OUT_FROM, "From"},
...
=======
        ...
        {STRING_FOR_MIDI_MACRO, "MIDI Macros"},
        {STRING_FOR_MACRO_1, "Macro 1"},
        {STRING_FOR_MACRO_2, "Macro 2"},
        {STRING_FOR_MACRO_3, "Macro 3"},
        {STRING_FOR_MACRO_4, "Macro 4"},
        {STRING_FOR_MACRO_LEADER, "Leader"},
        {STRING_FOR_MACRO_FOLLOWERS, "Followers"},
        {STRING_FOR_MACRO_FOLLOWER_1, "Follower 1"},
        {STRING_FOR_MACRO_FOLLOWER_2, "Follower 2"},
        {STRING_FOR_MACRO_FOLLOWER_3, "Follower 3"},
        {STRING_FOR_MACRO_FOLLOWER_4, "Follower 4"},
        {STRING_FOR_MACRO_FOLLOWER_5, "Follower 5"},
        {STRING_FOR_MACRO_FOLLOWER_6, "Follower 6"},
        {STRING_FOR_MACRO_FOLLOWER_7, "Follower 7"},
        {STRING_FOR_MACRO_FOLLOWER_8, "Follower 8"},
        {STRING_FOR_MACRO_FOLLOWER_CC, "CC"},
        {STRING_FOR_MACRO_FROM, "From"},
        {STRING_FOR_MACRO_TO, "To"},
        {STRING_FOR_MACRO_SEND, "Send"},
        {STRING_FOR_MACRO_ACTIVE, "Active"},
        {STRING_FOR_MACRO_ENABLE_MACROS, "Enable Macros"},
