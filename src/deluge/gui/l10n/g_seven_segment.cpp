...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_FAN_OUT_GROUP_1, "GRP1"},
        {STRING_FOR_FAN_OUT_GROUP_2, "GRP2"},
        {STRING_FOR_FAN_OUT_GROUP_3, "GRP3"},
        {STRING_FOR_FAN_OUT_GROUP_4, "GRP4"},
        {STRING_FOR_FAN_OUT_SOURCE, "SRC"},
        {STRING_FOR_FAN_OUT_DESTINATIONS, "DEST"},
