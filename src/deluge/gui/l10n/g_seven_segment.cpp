...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_ARP_MIDI_INTERCEPT, "ICPT"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_SHORTCUT_OVERLAY, "OVER"},
        {STRING_FOR_COMMUNITY_FEATURE_MACROS, "MCRS"},
        {STRING_FOR_COMMUNITY_FEATURE_SHOW_REAL_UNITS, "UNIT"},
        {STRING_FOR_COMMUNITY_FEATURE_SPECTRUM_ANALYZER, "SPEC"},
        {STRING_FOR_TRACK_STILL_HAS_CLIPS_IN_SESSION, "CANT"},
        {STRING_FOR_FX_TRACK_ALREADY_EXISTS, "CANT"},
        ...
        {STRING_FOR_CONFIGURE_EXPORT_STEMS_KIT_ROWS, "ROWS"},
        ...
        {STRING_FOR_MACRO, "MCRS"},
        {STRING_FOR_MACROS, "MCRS"},
        {STRING_FOR_PARAMETERS, "PRMS"},
        {STRING_FOR_MACRO_1, "MAC1"},
        {STRING_FOR_MACRO_2, "MAC2"},
        {STRING_FOR_MACRO_3, "MAC3"},
        {STRING_FOR_MACRO_4, "MAC4"},
        {STRING_FOR_MACRO_SOURCE, "SRC"},
        {STRING_FOR_MACRO_TARGETS, "TGTS"},
        {STRING_FOR_MACRO_TARGET_1, "TGT1"},
        {STRING_FOR_MACRO_TARGET_2, "TGT2"},
        {STRING_FOR_MACRO_TARGET_3, "TGT3"},
        {STRING_FOR_MACRO_TARGET_4, "TGT4"},
        {STRING_FOR_MACRO_TARGET_5, "TGT5"},
        {STRING_FOR_MACRO_TARGET_6, "TGT6"},
        {STRING_FOR_MACRO_TARGET_7, "TGT7"},
        {STRING_FOR_MACRO_TARGET_8, "TGT8"},
