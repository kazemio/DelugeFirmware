...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_FOLLOW_CHANNEL_TRACK, "TRK"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK1, "T1"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK2, "T2"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK3, "T3"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK4, "T4"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK5, "T5"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK6, "T6"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK7, "T7"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK8, "T8"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK9, "T9"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK10, "T10"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK11, "T11"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK12, "T12"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK13, "T13"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK14, "T14"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK15, "T15"},
        {STRING_FOR_FOLLOW_CHANNEL_TRACK16, "T16"},
        ...
        {STRING_FOR_FAN_OUT, "FANO"},
        {STRING_FOR_FAN_OUT_SOURCE, "SRC"},
        {STRING_FOR_FAN_OUT_DEST_1, "DST1"},
        {STRING_FOR_FAN_OUT_DEST_2, "DST2"},
        {STRING_FOR_FAN_OUT_DEST_3, "DST3"},
        {STRING_FOR_FAN_OUT_DEST_4, "DST4"},
        {STRING_FOR_FAN_OUT_DEST_5, "DST5"},
        {STRING_FOR_FAN_OUT_DEST_6, "DST6"},
        {STRING_FOR_FAN_OUT_DEST_7, "DST7"},
        {STRING_FOR_FAN_OUT_DEST_8, "DST8"},
    },
    &built_in::english,
};
} // namespace deluge::l10n::built_in
