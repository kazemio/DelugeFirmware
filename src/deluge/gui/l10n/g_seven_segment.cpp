...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_MACRO, "MACR"},
        ...
        {STRING_FOR_MACRO, "MACR"},
        {STRING_FOR_MIDI_MACRO, "MACR"},
        {STRING_FOR_MACRO_1, "MAC1"},
        {STRING_FOR_MACRO_2, "MAC2"},
        {STRING_FOR_MACRO_3, "MAC3"},
        {STRING_FOR_MACRO_4, "MAC4"},
        {STRING_FOR_MACRO_LEADER, "LEAD"},
        {STRING_FOR_MACRO_FOLLOWERS, "FLWR"},
        {STRING_FOR_MACRO_FOLLOWER_1, "FLW1"},
        {STRING_FOR_MACRO_FOLLOWER_2, "FLW2"},
        {STRING_FOR_MACRO_FOLLOWER_3, "FLW3"},
        {STRING_FOR_MACRO_FOLLOWER_4, "FLW4"},
        {STRING_FOR_MACRO_FOLLOWER_5, "FLW5"},
        {STRING_FOR_MACRO_FOLLOWER_6, "FLW6"},
        {STRING_FOR_MACRO_FOLLOWER_7, "FLW7"},
        {STRING_FOR_MACRO_FOLLOWER_8, "FLW8"},
        {STRING_FOR_MACRO_FOLLOWER_CC, "CC"},
        {STRING_FOR_MACRO_FROM, "FROM"},
        {STRING_FOR_MACRO_TO, "TO"},
        {STRING_FOR_MACRO_SEND, "SEND"},
        {STRING_FOR_MACRO_ENABLED, "ENBL"},
        {STRING_FOR_MACRO_ENABLE_ALL, "ALL"},
