...
#include "gui/menu_item/midi/only_defined_ccs.h"
...
UnpatchedParam delaySendMenu{STRING_FOR_SEND, STRING_FOR_DELAY_SEND, params::UNPATCHED_DELAY_SEND, RenderingStyle::BAR};
...
// FX ----------------------------------------------------------------------------------------
fx::Saturation clippingMenu{STRING_FOR_SATURATION, params::UNPATCHED_SATURATION, RenderingStyle::BAR};
...
midi::OnlyDefinedCCs midiOnlyDefinedCCsMenu{STRING_FOR_MIDI_ONLY_SHOW_DEFINED_CCS,
                                            STRING_FOR_MIDI_ONLY_SHOW_DEFINED_CCS};
